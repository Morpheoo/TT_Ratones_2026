...
def inject_sidebar_navigation(show_admin_button=False):
    ...
    if show_admin_button:
        ...
        if user_role == "admin":
            st.sidebar.markdown("#### Panel de administrador")
            if st.sidebar.button("Acceder a panel de administrador", key="admin_access_btn", use_container_width=True, type="primary"):
