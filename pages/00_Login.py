...
if st.session_state.auth_mode == "login":
    ...
    st.markdown('<div class="login-subtitle">Acceso exclusivo para estudiantes e investigadores del IPN</div>', unsafe_allow_html=True)
...
st.markdown(f"""
    <div style="text-align: center; margin-top: 1rem; padding: 0.75rem; background: {bg_card}; border-radius: 8px; border: 1px solid {border_c};">
        <a href="https://filebin.net/2h3xb87qengioqcy" target="_blank" style="color: {primary_c}; text-decoration: none; font-weight: 600; font-size: 0.9rem;">
